...
nat_type, nat = stun.get_nat_type(sock, source_ip, source_port, stun_host='stun.l.google.com', stun_port=19302)
...
remote_ip, remote_port = input("Введите `адрес:порт` другого компьютера > ").split(':')
